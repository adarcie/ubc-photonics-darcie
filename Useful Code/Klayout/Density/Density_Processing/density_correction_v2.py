...
###################### PERFORM RESIZING #################################
  ...
  for x_ind in range(1):
    for y_ind in range(1):
      ...
      pya.ShapeProcessor().size(layout,cell,layer_temp,shapes_temp,bias_val,pya.EdgeProcessor.ModeOr,True,True,True)
